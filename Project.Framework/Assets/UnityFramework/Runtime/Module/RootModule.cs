...
namespace UnityFramework
{
    ...
    public sealed class RootModule : MonoBehaviour
    {
        ...
        [SerializeField]
        private string textHelperTypeName = "UnityFramework.DefaultTextHelper";

        [SerializeField]
        private string logHelperTypeName = "UnityFramework.DefaultLogHelper";

        [SerializeField]
        private string jsonHelperTypeName = "UnityFramework.DefaultJsonHelper";
