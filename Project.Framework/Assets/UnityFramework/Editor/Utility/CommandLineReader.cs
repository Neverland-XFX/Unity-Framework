...
Example1:
                ...
                set BUILDROOT=G:/github/UnityFramework/UnityProject/Bundles

                %UNITYEDITOR_PATH%/Unity.exe %WORKSPACE%/UnityProject -logFile %LOGFILE% -executeMethod UnityFramework.ReleaseTools.BuildPackage -quit -batchmode -CustomArgs:Language=en_US;Version=1.02;outputRoot=%BUILDROOT%
